    ...
    <Card className="w-full">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          {/* Wysokość względem viewportu (clamp 7rem–16rem): na laptopie cały formularz (pole + strefa
              dropu + „Wyślij") mieści się bez przewijania, na dużym ekranie pole nadal rośnie do 16rem. */}
          <Textarea
            id="ingest-text"
            value={text}
            ...
            className="field-sizing-fixed h-[clamp(7rem,26vh,16rem)] resize-none overflow-y-auto font-mono text-sm"
          />
