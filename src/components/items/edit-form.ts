...
/** Buduje payload edycji: title trim, description pusty/whitespace → null, type bez zmian. */
export function buildEditPayload(title: string, description: string, type: ItemType): EditItemInput {
