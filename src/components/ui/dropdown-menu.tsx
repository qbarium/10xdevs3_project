...
// shadcn „new-york" dropdown-menu na istniejącym unified `radix-ui` (BEZ nowej zależności npm —
// @radix-ui/react-dropdown-menu jest tranzytywnie pod `radix-ui`, jak Select/Dialog). Minimalny
// podzbiór używany przez OperationalStatusBadge: Root + Trigger + Content (w Portalu) + Item.
