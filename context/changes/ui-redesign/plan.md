...
- [x] 6.1 Lint przechodzi (`npm run lint`) — aaf3d57
- [x] 6.2 Build przechodzi (`npm run build`) — aaf3d57
- [x] 6.3 Testy jednostkowe przechodzą (`npm test`) — aaf3d57
...
- [x] 7.1 Lint przechodzi (`npm run lint`) — 3c4b330
- [x] 7.2 Build przechodzi (`npm run build`) — 3c4b330
- [x] 7.3 Testy jednostkowe przechodzą (`npm test`) — 3c4b330
