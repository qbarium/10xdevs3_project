...
- [ ] 3.3 Testy jednostkowe przechodzą (`npm test`, w tym `labels`/`state-filter`)
- [ ] 3.4 E2E przechodzi na zimnym starcie (`npm run e2e`)
...
- [ ] 5.4 E2E przechodzi (`npm run e2e`)
...
- [ ] 6.3 Testy jednostkowe przechodzą (`npm test`)
