...
- [x] 3.1 Lint (type-checked) przechodzi: `npm run lint` — b096571
- [x] 3.2 Build produkcyjny przechodzi: `npm run build` — b096571
- [x] 3.3 Testy jednostkowe bez regresji: `npm run test` — b096571
