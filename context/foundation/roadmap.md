...
| D        | Wejścia poboczne i diagnostyka | `S-07` / `S-08` → `S-10`                         | `S-07`/`S-08` dołączają do Strumienia A w `S-02`; `S-10` rozbudowuje dziennik sesji (`S-08`) i reużywa operacje z `S-05`/`S-06`. |
